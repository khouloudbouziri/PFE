...
public class JwtService {
    ...
    public String extractVisitorname(String token) {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        final String visitorname = extractVisitorname(token);
        return (visitorname.equals(userDetails.getUsername())) && !isTokenExpired(token);
    }
