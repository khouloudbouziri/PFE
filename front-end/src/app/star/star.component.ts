...
do4(){
    ...
    console.log((document.getElementById("rating-value")as HTMLButtonElement).value)
    console.log((document.getElementById("5")as HTMLButtonElement).value)
  }
  fonction(){
    (document.getElementById("j1")as HTMLButtonElement).addEventListener('click', this.do0);
    (document.getElementById("2")as HTMLButtonElement).addEventListener('click', this.do1);
    (document.getElementById("3")as HTMLButtonElement).addEventListener('click', this.do2);
    (document.getElementById("4")as HTMLButtonElement).addEventListener('click', this.do3);
    (document.getElementById("5")as HTMLButtonElement).addEventListener('click', this.do4);
  }
